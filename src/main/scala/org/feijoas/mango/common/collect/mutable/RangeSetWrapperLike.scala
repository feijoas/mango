 ...
 */
@Beta
private[mango] trait MutableRangeSetWrapperLike[C, O <: Ordering[C], +Repr <: MutableRangeSetWrapperLike[C, O, Repr] with RangeSet[C, O]]
  extends RangeSetWrapperLike[C, O, Repr] with RangeSet[C, O] {
  self =>
  ...
  override def addAll(other: RangeSet[C, O]) = other match {
    case that: MutableRangeSetWrapperLike[C, O, _] => delegate.addAll(that.delegate)
    case _                                         => super.addAll(other)
  }

  override def removeAll(other: RangeSet[C, O]) = other match {
    case that: MutableRangeSetWrapperLike[C, O, _] => delegate.removeAll(that.delegate)
